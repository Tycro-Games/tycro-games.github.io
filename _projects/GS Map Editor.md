...
My primary goal was learning how to **extend Godot with C++** (coming from simpler custom engines), while exploring rendering techniques, editor tool integration, and Godot's extension architecture.
...
*Video with basic edges with AA applied*
...
*Screenshot of the political map with basic edge detection*
...
*HQX shader applied to the political map*
...
*Artifacts due to the alpha of the simple borders*
...
*Screenshot from Oikoumene samples*
...
*Smooth borders on large continental landmasses*
...
*Handling complex coastal geometry and fjords*
...
*Island chains and separated territories*
