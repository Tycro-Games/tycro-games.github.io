...
**Voxmos** (name is still a work in progress) is a FPS mining game that features raytracing and voxel mining with destruction made with the **Thermite** engine. The engine was built from the beginning of the project in parallel with the design of the game. The team consisted of 10 programmers, 3 designers and 3 artists.

<video controls src="../assets/media/thermite/trailer-block-c.mp4" title="Title"></video>

**Key Achievement:** Collaboration with other students on a bigger project (6 months) and **publication** on Steam. My biggest accomplishment was getting to know others and working with them while having fun and even learning programming beyond engine programming.
...
## Events via entt, rudimentary way to decouple
